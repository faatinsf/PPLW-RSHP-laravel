        ...
        <div class="col-lg-8">
            <div class="card shadow mb-4">
                <div class="card-header py-3">
                    <h6 class="m-0 font-weight-bold text-primary">Form Tambah Data Kode Tindakan Terapi</h6>
                </div>
                <div class="card-body">
                    <form action="{{ route('kodetindakanterapi.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <small class="form-text text-muted">
                                Kode akan otomatis diubah menjadi huruf besar. Maksimal 5 karakter.
                            </small>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control @error('deskripsi_tindakan_terapi') is-invalid @enderror" 
                                      ...
                                      rows="3"
                                      placeholder="Deskripsi detail tindakan atau terapi"
            ...
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    ...
                    <ul class="small">
                        ...
                        <li>Kode harus unik (tidak boleh duplikat)</li>
                        <li>Deskripsi maksimal 1000 karakter</li>
                    </ul>
                </div>
            </div>
        </div>
